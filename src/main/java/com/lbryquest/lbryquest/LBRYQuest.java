...
public class LBRYQuest extends JavaPlugin {
  ...
  public static final String LBRY_NODE_HOST =
      System.getenv("LBRY_PORT_9246_TCP_ADDR") != null
          ? System.getenv("LBRY_PORT_9246_TCP_ADDR")
          : null;
  public static final int LBRY_NODE_PORT =
      System.getenv("LBRY_PORT_9246_TCP_PORT") != null
          ? Integer.parseInt(System.getenv("LBRY_PORT_9246_TCP_PORT"))
          : 9246;
  public static final String SERVERDISPLAY_NAME =
      System.getenv("SERVERDISPLAY_NAME") != null ? System.getenv("SERVERDISPLAY_NAME") : "LBC";
  ...
  public static final String BLOCKCYPHER_CHAIN =
      System.getenv("BLOCKCYPHER_CHAIN") != null ? System.getenv("BLOCKCYPHER_CHAIN") : "lbc/test3";
  public static final String LBRY_NODE_USERNAME = System.getenv("LBRY_ENV_USERNAME");
  public static final String LBRY_NODE_PASSWORD = System.getenv("LBRY_ENV_PASSWORD");
  ...
  public void onEnable() {
    log("[startup] LBRYQuest starting");
    ...
    try {
      ...
      if (LBRY_NODE_HOST != null) {
        System.out.println("[startup] checking LBRY node connection");
        getBlockChainInfo();
      }
  ...
  public static final Wallet generateNewWallet()
    ...
    URL url = new URL("https://explorer.lbry.com" + "/address");
  ...
  public JSONObject getBlockChainInfo() throws org.json.simple.parser.ParseException {
    ...
    try {
      ...
      URL url = new URL("http://" + LBRY_NODE_HOST + ":" + LBRY_NODE_PORT);
      System.out.println(url.toString());
      HttpURLConnection con = (HttpURLConnection) url.openConnection();
      String userPassword = LBRY_NODE_USERNAME + ":" + LBRY_NODE_PASSWORD;
      String encoding = java.util.Base64.getEncoder().encodeToString(userPassword.getBytes());
      con.setRequestProperty("Authorization", "Basic " + encoding);

      con.setRequestMethod("POST");
      con.setRequestProperty("User-Agent", "lbryquest plugin");
      ...
      System.out.println("problem connecting with LBRY node");
  ...
  public void updateScoreboard(final Player player) {
    try {
      ...
      if (LBRYQuest.BLOCKCYPHER_CHAIN != null) {
        Score score =
  ...
  public void createPet(User user, String pet_name) {
    ...
    LBRYQuest.REDIS.zincrby("player:tx", PET_PRICE, user.uuid.toString());
  ...
  public void setTotalExperience(Player player) {
    int rawxp = 0;
    if (LBRYQuest.REDIS.exists("experience.raw." + player.getUniqueId().toString())) {
      rawxp =
          Integer.parseInt(LBRYQuest.REDIS.get("experience.raw." + player.getUniqueId().toString()));
    }
  ...
  public void saveLandData(Player player, String name, int x, int z)
    ...
    LBRYQuest.REDIS.zincrby("player:tx", LAND_PRICE, player.getUniqueId().toString());
    LBRYQuest.REDIS.set(chunk + "" + x + "," + z + "owner", player.getUniqueId().toString());
    LBRYQuest.REDIS.set(chunk + "" + x + "," + z + "name", name);
      ...
      if(validName(name)) {
            ...
            if (REDIS.get(tempchunk + "" + x + "," + z + "owner") == null) {
              try {
                ...
                BukkitScheduler scheduler = Bukkit.getServer().getScheduler();
                final LBRYQuest lbryQuest = this;
                if (LBRYQuest.BLOCKCYPHER_CHAIN != null) {
                  ...
                  int land_price_in_emeralds =
                      (int) ((LAND_PRICE * landxprice) / LBRYQuest.DENOMINATION_FACTOR);
            ...
            } else if (LBRYQuest.REDIS.get(tempchunk + "" + x + "," + z + "name").equals(name)) {
              player.sendMessage(ChatColor.DARK_RED + "You already own this land!");
            } else {
              // Rename land
              LBRYQuest.REDIS.set(tempchunk + "" + x + "," + z + "name", name);
              player.sendMessage(
                  ChatColor.GREEN
