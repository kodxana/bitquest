...
public class User {
  ...
  public User(Connection db_con, UUID _uuid)
    ...
    if (rs.next()) {
      ...
      this.wallet = LBRYQuest.generateNewWallet();
  ...
  //        LBRYQuest.REDIS.incrBy("experience.raw."+this.player.getUniqueId().toString(),exp);
  //        setTotalExperience(experience());
  //        System.out.println(exp);
  //    }
  public int experience() {
    if (LBRYQuest.REDIS.get("experience.raw." + this.uuid.toString()) == null) {
      return 0;
    } else {
      return Integer.parseInt(LBRYQuest.REDIS.get("experience.raw." + this.uuid.toString()));
    }
  }
